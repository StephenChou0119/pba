...
import models.efficientnet_model as efficientnet_model
...
if __name__ == "__main__":
    ...
    logits,_ = build_model(images, 'efficientnet-b0', True,
                                override_params={'num_classes': 2}
                                )
    import numpy as np
    with tf.Session() as sess:

        a = sess.run(logits,feed_dict = {images: np.ones([16, 224, 224, 3])})
        print()